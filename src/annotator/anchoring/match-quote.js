...
import { runInWorker } from '../util/run-in-worker';
...
/**
 * Context in which a quote originally appeared. This is used to choose the
 * best match.
 *
 * @typedef Context
 * @prop {string} [prefix] - Expected text before the quote
 * @prop {string} [suffix] - Expected text after the quote
 * @prop {number} [hint] - Expected offset of match within text
 */
 ...
 *
 * Falls back to executing the quote synchronously if the worker cannot be
