 ...
 * This can include:
 *
 *  - Requests that could not be sent (ie. `fetch` failed)
 *  - Requests that were sent but returned a non-2xx response
 */
...
export async function fetchJSON(url, init) {
  ...
  try {
    ...
    throw new FetchError(response, 'Failed to read response');
  }
