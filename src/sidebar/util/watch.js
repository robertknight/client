 ...
 * @param {((current: T, previous: T) => boolean)|null} compare -
 *   Comparison function that tests whether the results of two `getValue` calls
 *   are equal. If `null`, a strict equality check is used
 ...
 */
export function watch(subscribe, getValue, compare, callback) {
